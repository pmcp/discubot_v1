...
export const discussioncollectionsDiscussionSchema = z.object({
...
export const discussioncollectionsDiscussionsColumns = [
...
export const discussioncollectionsDiscussionsConfig = {
  name: 'discussioncollectionsDiscussions',
  layer: 'discussion-collections',
  apiPath: 'discussion-collections-discussions',
  componentName: 'DiscussionCollectionsDiscussionsForm',
  schema: discussioncollectionsDiscussionSchema,
  defaultValues: {
    sourceType: '',
    sourceThreadId: '',
    sourceUrl: '',
  ...
  columns: discussioncollectionsDiscussionsColumns,
}

export const useDiscussionCollectionsDiscussions = () => discussioncollectionsDiscussionsConfig

// Default export for auto-import compatibility
export default function () {
  return {
    defaultValue: discussioncollectionsDiscussionsConfig.defaultValues,
    schema: discussioncollectionsDiscussionsConfig.schema,
    columns: discussioncollectionsDiscussionsConfig.columns,
    collection: discussioncollectionsDiscussionsConfig.name
  }
}
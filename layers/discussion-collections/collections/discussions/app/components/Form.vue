...
import type { DiscussionCollectionsDiscussionFormProps, DiscussionCollectionsDiscussionFormData } from '../../types'

const props = defineProps<DiscussionCollectionsDiscussionFormProps>()
const { defaultValue, schema, collection } = useDiscussionCollectionsDiscussions()
...
const state = ref<DiscussionCollectionsDiscussionFormData & { id?: string | null }>(initialValues)

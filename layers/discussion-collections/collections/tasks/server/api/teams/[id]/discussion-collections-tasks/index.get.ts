...
import { getAllDiscussionCollectionsTasks, getDiscussionCollectionsTasksByIds } from '../../../../database/queries'
...
export default defineEventHandler(async (event) => {
  ...
  if (query.ids) {
    ...
    return await getDiscussionCollectionsTasksByIds(team.id, ids)
  }

  return await getAllDiscussionCollectionsTasks(team.id)
})
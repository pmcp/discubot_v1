...
import type { DiscussionCollectionsTaskFormProps, DiscussionCollectionsTaskFormData } from '../../types'

const props = defineProps<DiscussionCollectionsTaskFormProps>()
const { defaultValue, schema, collection } = useDiscussionCollectionsTasks()
...
const state = ref<DiscussionCollectionsTaskFormData & { id?: string | null }>(initialValues)

...
import type { DiscussionCollectionsSyncjobFormProps, DiscussionCollectionsSyncjobFormData } from '../../types'

const props = defineProps<DiscussionCollectionsSyncjobFormProps>()
const { defaultValue, schema, collection } = useDiscussionCollectionsSyncjobs()
...
const state = ref<DiscussionCollectionsSyncjobFormData & { id?: string | null }>(initialValues)

...
import type { DiscussionCollectionsSourceconfigFormProps, DiscussionCollectionsSourceconfigFormData } from '../../types'

const props = defineProps<DiscussionCollectionsSourceconfigFormProps>()
const { defaultValue, schema, collection } = useDiscussionCollectionsSourceconfigs()
...
const state = ref<DiscussionCollectionsSourceconfigFormData & { id?: string | null }>(initialValues)

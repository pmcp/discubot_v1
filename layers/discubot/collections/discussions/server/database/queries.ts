...
import type { DiscubotDiscussion, NewDiscubotDiscussion } from '#layers/discubot/types'
import * as configsSchema from '#layers/discubot-configs/server/database/schema'
import * as jobsSchema from '#layers/discubot-jobs/server/database/schema'
...
export async function createDiscubotDiscussion(data: NewDiscubotDiscussion) {
  const db = useDB()
